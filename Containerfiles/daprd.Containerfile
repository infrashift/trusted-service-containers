...
LABEL org.opencontainers.image.source="${SOURCE_URL}" \
      ...
      org.opencontainers.image.title="Trusted Dapr Sidecar" \
      org.opencontainers.image.description="Dapr application sidecar (daprd), built from source on trusted UBI9 Micro" \
      ...
      io.openshift.tags="dapr,daprd,sidecar,ubi9,vetted"
...
COPY --from=builder /out/daprd /usr/bin/daprd
...
RUN set -euo pipefail; \
    ...
    printf 'dapr:x:1001:0:Trusted Dapr Sidecar service account:/home/dapr:/sbin/nologin\n' >> /etc/passwd; \
...
EXPOSE 3500 50001 50002 9090

ENTRYPOINT ["/usr/bin/daprd"]
